...
(function () {
  ...
  var CSS = [
    ...
    '@media(max-width:640px){',
      ...
      '@keyframes butterfly-flight{',
        '0%{opacity:0;right:4.5%;top:calc(env(safe-area-inset-top,0px) + 40px);transform:scale(0.4)}',
        '100%{opacity:1;right:4.5%;top:calc(env(safe-area-inset-top,0px) + 40px);transform:scale(1)}',
      '}',
    '}',
