...
(function () {
  ...
  var CSS = [
    ...
    '@keyframes butterfly-flight{',
      '0%{opacity:1;right:0%;top:calc(env(safe-area-inset-top,0px) + 20px);transform:scaleX(-1) rotate(10deg)}',
      '28%{opacity:1;right:6%;top:calc(env(safe-area-inset-top,0px) + 40px);transform:scaleX(1) rotate(-8deg)}',
      '52%{opacity:1;right:4%;top:calc(env(safe-area-inset-top,0px) + 15px);transform:scaleX(-1) rotate(6deg)}',
      '76%{opacity:1;right:5.5%;top:calc(env(safe-area-inset-top,0px) + 50px);transform:scaleX(1) rotate(2deg)}',
      '100%{opacity:0.18;right:5.5%;top:calc(env(safe-area-inset-top,0px) + 50px);transform:scaleX(1) rotate(0deg)}',
    '}',
    '@media(max-width:640px){',
      '#butterfly-nav{width:96px;height:108px}',
      '@keyframes butterfly-flight{',
        '0%{opacity:1;right:0%;top:calc(env(safe-area-inset-top,0px) + 15px);transform:scaleX(-1) rotate(12deg)}',
        '30%{opacity:1;right:5%;top:calc(env(safe-area-inset-top,0px) + 35px);transform:scaleX(1) rotate(-6deg)}',
        '60%{opacity:1;right:4%;top:calc(env(safe-area-inset-top,0px) + 10px);transform:scaleX(-1) rotate(4deg)}',
        '85%{opacity:1;right:4.5%;top:calc(env(safe-area-inset-top,0px) + 40px);transform:scaleX(1) rotate(1deg)}',
        '100%{opacity:0.16;right:4.5%;top:calc(env(safe-area-inset-top,0px) + 40px);transform:scaleX(1) rotate(0deg)}',
      '}',
    '}',
