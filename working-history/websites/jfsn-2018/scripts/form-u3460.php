...
{
	$to = 'Jeff@JFSN.com';
	$subject = 'Contact Red30 Submission';
	...
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>NAME:</b></td><td>' . htmlentities($_REQUEST["custom_U3528"],ENT_COMPAT,'UTF-8') . '</td></tr>';
	...
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>WEBSITE:</b></td><td>' . htmlentities($_REQUEST["custom_U3461"],ENT_COMPAT,'UTF-8') . '</td></tr>';
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>MESSAGE:</b></td><td>' . htmlentities($_REQUEST["custom_U3523"],ENT_COMPAT,'UTF-8') . '</td></tr>';
