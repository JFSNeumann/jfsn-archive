...
(function () {
  ...
  var CSS = [
    ...
    '#site-menu-overlay.sm-open #butterfly-nav{animation:butterfly-flight 0.8s ease-out forwards}',
    '@keyframes butterfly-flight{',
      '0%{opacity:0;right:5.5%;top:calc(env(safe-area-inset-top,0px) + 85px);transform:scale(0.4)}',
      '100%{opacity:0.85;right:5.5%;top:calc(env(safe-area-inset-top,0px) + 85px);transform:scale(1)}',
    '}',
    '@media(max-width:640px){',
      '#butterfly-nav{width:96px;height:108px}',
      '@keyframes butterfly-flight{',
        '0%{opacity:0;right:4.5%;top:calc(env(safe-area-inset-top,0px) + 100px);transform:scale(0.4)}',
        '100%{opacity:0.85;right:4.5%;top:calc(env(safe-area-inset-top,0px) + 100px);transform:scale(1)}',
      '}',
    '}',
