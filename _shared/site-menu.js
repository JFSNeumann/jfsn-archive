...
(function () {
  ...
  var CSS = [
    ...
    '@keyframes butterfly-flight{',
      ...
      '100%{opacity:1;right:5.5%;top:calc(env(safe-area-inset-top,0px) + 85px);transform:scale(1)}',
    '}',
    '@media(max-width:640px){',
      ...
      '@keyframes butterfly-flight{',
        ...
        '100%{opacity:1;right:4.5%;top:calc(env(safe-area-inset-top,0px) + 100px);transform:scale(1)}',
      '}',
    '}',
