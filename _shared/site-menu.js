...
(function () {
  ...
  var CSS = [
    ...
    '@keyframes butterfly-flight{',
      '0%{opacity:0;right:5.5%;top:calc(env(safe-area-inset-top,0px) + 50px);transform:scale(0.4)}',
      '100%{opacity:1;right:5.5%;top:calc(env(safe-area-inset-top,0px) + 50px);transform:scale(1)}',
    '}',
    '@media(max-width:640px){',
      '#butterfly-nav{width:96px;height:108px}',
      '@keyframes butterfly-flight{',
        '0%{opacity:0;right:4.5%;top:calc(env(safe-area-inset-top,0px) + 65px);transform:scale(0.4)}',
        '100%{opacity:1;right:4.5%;top:calc(env(safe-area-inset-top,0px) + 65px);transform:scale(1)}',
      '}',
    '}',
