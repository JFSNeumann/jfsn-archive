...
- Python 3 is required for catalog/sitemap generation (`artworks/build_catalog.py`) and static artwork page generation (`tools/generators/gen-artwork-pages.py`).
