...
| Backup family contact | Allison | _[FILL IN — phone/email]_ | Named throughout `docs/` as the designated custodian (`FINAL-PRESERVATION-HANDOFF-2026-06-11.md` is addressed to her; Apple Digital Legacy already grants her Mac access). Contact details still need filling in here. |
