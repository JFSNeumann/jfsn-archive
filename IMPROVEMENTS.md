...
### Technical
- [ ] **Deploy session 36** — BUILT + preview-verified, not yet live. (1) JFSN.app deploy (index.html, artwork.html, catalog*.json, api/v1, 1,084 regenerated pages, sw.js CACHE_V `jfsn-20260614010023`). (2) lftp the 3 recompressed hero AVIFs (`art0953/art1008/art1009-hero.avif`) to `/artworks/` flat — optional ~679 KB win, decoupled from LCP. (3) `bash end-session.sh`. (4) **Re-run Lighthouse mobile** to confirm the LCP swing closed.
