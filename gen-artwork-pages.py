...
def generate_page(work, idx, all_works, colors):
    ...
    if prev_id:
        prev_html = (
            ...
            f'<span class="material-symbols-outlined text-deep-ink group-hover:text-international-orange mr-sm shrink-0">arrow_back</span>'
    ...
    if next_id:
        next_html = (
            ...
            f'</div>'
            f'<span class="material-symbols-outlined text-deep-ink group-hover:text-international-orange ml-sm shrink-0">arrow_forward</span>'
            f'</a>'
        )
    else:
        next_html = '<span></span>'
...
<link href="https://fonts.googleapis.com/css2?family=Playfair+Display:wght@400;500;600;700&family=Inter:wght@400;500;600&family=Material+Symbols+Outlined:opsz,wght,FILL@24,400,0..1&display=swap" rel="stylesheet"/>
    ...
    <section class="md:col-span-8 border border-deep-ink">
      ...
      <div class="p-sm border-t border-deep-ink flex justify-between items-center">
        ...
        <a href="../full/{e(work['file'])}"
          ...
          Full resolution <span class="material-symbols-outlined" style="font-size:14px;">zoom_in</span>
        </a>
      </div>
    </section>
