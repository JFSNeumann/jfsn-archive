...
function emailFormSubmission()
{
	...
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>NAME:</b></td><td>' . htmlentities($_REQUEST["custom_U18978"],ENT_COMPAT,'UTF-8') . '</td></tr>';
	...
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>WEBSITE:</b></td><td>' . htmlentities($_REQUEST["custom_U18965"],ENT_COMPAT,'UTF-8') . '</td></tr>';
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>MESSAGE:</b></td><td>' . htmlentities($_REQUEST["custom_U18983"],ENT_COMPAT,'UTF-8') . '</td></tr>';
